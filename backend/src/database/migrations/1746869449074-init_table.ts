...
export class InitTable1746869449074 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."tokens_user_role_enum" AS ENUM('0', '1')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."customers_gender_enum" AS ENUM('0', '1', '2')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."admins_gender_enum" AS ENUM('0', '1', '2')`);
