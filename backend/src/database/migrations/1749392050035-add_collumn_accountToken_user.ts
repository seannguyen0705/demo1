...
export class AddCollumnAccountTokenUser1749392050035 implements MigrationInterface {
  name = 'AddCollumnAccountTokenUser1749392050035';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "candidates" ADD "account_token" character varying`);
    await queryRunner.query(`ALTER TABLE "employers" ADD "account_token" character varying`);
    ...
    await queryRunner.query(`ALTER TABLE "admins" ADD "account_token" character varying`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_601fd5d085891783c5deaf9829"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_a087d81ebf8002c99f755a10dd"`);
    await queryRunner.query(`ALTER TABLE "admins" DROP COLUMN "account_token"`);
    await queryRunner.query(`ALTER TABLE "job_addresses" DROP COLUMN "updated_at"`);
    await queryRunner.query(`ALTER TABLE "job_addresses" DROP COLUMN "created_at"`);
    await queryRunner.query(`ALTER TABLE "job_skills" DROP COLUMN "updated_at"`);
    await queryRunner.query(`ALTER TABLE "job_skills" DROP COLUMN "created_at"`);
    await queryRunner.query(`ALTER TABLE "employers" DROP COLUMN "account_token"`);
    await queryRunner.query(`ALTER TABLE "candidates" DROP COLUMN "account_token"`);
    await queryRunner.query(
      `ALTER TABLE "job_skills" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone`,
    );
    await queryRunner.query(
