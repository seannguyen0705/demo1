...
export class AddCollumnExpireJob1749197931575 implements MigrationInterface {
  name = 'AddCollumnExpireJob1749197931575';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "jobs" ADD "expired_at" TIMESTAMP WITH TIME ZONE`);
