...
export class TableApplyJob1749051120356 implements MigrationInterface {
  name = 'TableApplyJob1749051120356';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "apply_jobs" ADD CONSTRAINT "UQ_eb292b80decb067cc60da331a81" UNIQUE ("job_id", "candidate_id")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "apply_jobs" DROP CONSTRAINT "UQ_eb292b80decb067cc60da331a81"`);
