      ...
      <div className="grid w-full max-w-6xl grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6 px-4 ">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold">Chào mừng bạn đến với Job Portal</h1>
            <p className="text-muted-foreground">Tạo tài khoản để bắt đầu hành trình tìm việc làm của bạn</p>
          </div>
          <RegisterForm />
